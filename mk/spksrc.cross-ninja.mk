...
ifeq ($(strip $(CMAKE_USE_NINJA)),1)
	...
	@$(RUN) ninja -C $(NINJA_BUILD_DIR) > spk_compile.log 2>&1
...
ifeq ($(strip $(NINJA_USE_DESTDIR)),0)
	@$(RUN) ninja -C $(NINJA_BUILD_DIR) install > spk_install.log 2>&1
else
	@$(RUN) DESTDIR=$(NINJA_DESTDIR) ninja -C $(NINJA_BUILD_DIR) install > spk_install.log 2>&1
endif
